<link rel="stylesheet" href="{{ URL::asset('css/shazdeDesigns/modalPhotos.css?v=1.1') }}">
        ...
        <div class="modal-content" style="background-color: #141518; border: none;">
            ...
            <div class="userInfoPhotoAlbum hideOnScreen">
                <a href="#" class="fullyCenterContent userPictureDiv circleBase type2 userProfileLinks">
                    <img class="photoAlbumUserPic resizeImgClass" alt="Dorna News" style="width: 100%"
                    ...
                    <div id="leftColPhotosModalMainDiv" class="selectedPhotoShowingModal" style="position: relative;">
                        <div style="position: relative; width: 100%;">
                            <div class="albumContent">
                                <img id="mainPhotoAlbum" alt="Dorna News">
                                <video id="mainVideoPhotoAlbum" controls></video>
                            </div>
                            <div
                                style="position: absolute; bottom: -25px; right: 0px; margin-top: 7px; display: flex; justify-content: center;">
                                <div id="photoAlbumLikeSection" class="photoAlbumLikeSection" style="display:none;">
                                    <div class="feedBackBtn" style="margin: 0px;">
                                        <div class="dislikeBox photoAlbumTopLikeButton photoAlbumTopDisLike disLikePhotoAlbum"
                                            onclick="likeAlbumPic(this,-1)">
                                            <div class="photoAlbumDisLikeCount" style="font-size: 25px"></div>
                                        </div>
                                        <div class="likeBox photoAlbumTopLikeButton photoAlbumTopLike likePhotoAlbum"
                                            onclick="likeAlbumPic(this,1)">
                            ...
                            <div id="deletePicIconsPhotoAlbum" class="deletePicIconsPhotoAlbum" dataValue="0"
                                onclick="openDeletePhotoModal()">
                                <img alt="delete" src="{{ URL::asset('images/icons/recycle-bin3.webp') }}"
                                    style="width: 35px; height: 35px">
                            </div>
                        </div>
                    </div>
                </div>
                <div id="rightColPhotosModalMainDiv" class="col-xs-12 col-sm-3 rightColPhotosModalMainDiv"
                    style="max-height: 85vh; overflow: hidden;">
                    <div class="userInfoPhotoAlbum hideOnPhone">
                        <a href="#" class="fullyCenterContent userPictureDiv circleBase type2 userProfileLinks">
                            <img alt="Dorna News" class="photoAlbumUserPic resizeImgClass" style="width: 100%"
                                onload="fitThisImg(this)">
                        </a>
                        <div class="commentWriterExperienceDetails photoAlbumTopUserName"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger"
                    onclick="doPhotoDeleteInAlbum()">{{ __('بله، حذف شود') }}</button>
            </div>
        </div>
    </div>
</div>
