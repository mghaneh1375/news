...
<link rel='stylesheet' type='text/css' href='{{ URL::asset('css/component/editor.css?v=1.1') }}' />
...
<div id="addPhotographerModal" class="addPhotographerModal hidden">
    ...
    <span id="photoEditor" class="ui_overlay ui_modal photoUploadOverlay">
                ...
                <div id="uploader-dlg" class="uploaderDlg hasFiles" style="height: calc(100% - 48px);">
                    <div id="dropAreaForUploadPhoto" class="startScreen infoScreen">
                        <div class="inner">
                            ...
                            <div class="invalidDragScreen infoScreen hidden">
                                <div class="inner">
                                    <div class="dropText">That image type is not supported. Please use a jpeg or png.
                                    </div>
                                </div>
                            ...
                            <div id="photographerLoadingPic" class="progressScreen infoScreen hidden">
                                <div class="inner">
                                    <img alt="loading" src="{{ URL::asset('images/loading2.gif?v=1.1') }}">
                                </div>
                            </div>
                        ...
                        <div class="footerTextBox stFooter">
                            ...
                            <a href="{{ route('policies') }}" target="_blank"
                                class="footerPolicyLink">{{ __('صفحه مقررات') }}</a>
                        </div>
                    </div>
                    <div id="uploadedPicInfoPage" class="template itemRow loading hidden"
                        ...
                        <div class="row uploadPicMainSection" style="display: flex">
                                    ...
                                    <div class="epPicBox">
                                        <div class="epPic">
                                            <div class="imgContainer rectangularImgBox">
                                                <img alt="loading" id="rectanglePicUploadPhoto" class="resizeImgClass"
                                                    onload="fitThisImg(this)">
                                            </div>
                                        </div>
                                        <div class="step6picText epicText">{{ __('قاب مستطیل') }}</div>
                                        <div class="epEditPicText" onclick="doEdit(1.77, 'rectanglePicUploadPhoto');"
                                            style="cursor: pointer;">{{ __('ویرایش') }}</div>
                                    </div>
                                    <div class="epPicBox">
                                        <div class="epPic">
                                            <div class="imgContainer squareImgBox">
                                                <img alt="loading" id="squarePicUploadPhoto" class="resizeImgClass"
                                                    onload="fitThisImg(this)">
                                            </div>
                                        </div>
                                        <div class="epPicText">{{ __('قاب مربع') }}</div>
                                        <div class="epEditPicText" onclick="doEdit(1, 'squarePicUploadPhoto');"
                                            style="cursor: pointer;">{{ __('ویرایش') }}</div>
                                    </div>
                                </div>
                                <div class="photoTemplateTypeDesc">
                                    {{ __('عکس‌های ما در دو نوع قاب مختلف نمایش داده می‌شود می‌توانید خود نسبت به برش نمایش مناسب عکس در داخل قاب اقدام نمایید در غیر اینصورت تصویر به صورت اتوماتیک برش می‌خورد') }}
                                </div>
                            ...
                            <div class="col-xs-5 uploadPicInfoSection">
                                ...
                                <div id="uploadPhotoPicAltDiv" class="epInputBox">
                                    <div class="epInputBoxText">
                                        <div class="epInputBoxRequired">
                                            <div class="icons epInputIconRequired redStar"></div>{{ __('عکس برای') }}:
                                        </div>
                                    </div>
                                    <input id="placeNameUploadPhoto" class="epInputBoxInput"
                                        onclick="searchPlaceForUploadPhoto()" placeholder="نام محل را وارد نمایید"
                                        readonly>
                                ...
                                <div id="uploadPhotoPicNameDiv" class="epInputBox">
                                    ...
                                    <input class="epInputBoxInput" id="uploadPhotoPicName"
                                        onkeydown="$('#uploadPhotoPicNameDiv').removeClass('inputUploadPhotosError')">
                                </div>
                                <div id="uploadPhotoPicAltDiv" class="epInputBox">
                                    <div class="epInputBoxText">
                                        <div class="epInputBoxRequired">{{ __('نام جایگزین') }}</div>
                                    </div>
                                    <input class="epInputBoxInput" id="uploadPhotoPicAlt"
                                        onkeydown="$('#uploadPhotoPicAltDiv').removeClass('inputUploadPhotosError')">
                                </div>
                                <div class="epRedNotice">
                                    {{ __('نام جایگزین توصیف کننده موضوعی است که از تصویر استنباط می شود') }}</div>

                                <div>
                                    <div class="epTitle">{{ __('توضیحات') }}</div>
                                    <textarea class="epAddresText"
                                        placeholder="{{ __('توضیحات همراه با عکس برای دوستانتان نمایش داده می شود.حداقل 100 کاراکتر') }}" maxlength="100"
                                        id="uploadPhotoDescription"></textarea>
                                </div>
                                    ...
                                    <div style="display: flex">
                                        <div class="secondStepPolicyCheckBox">
                                            <input id="uploadPhotoRole" type="checkbox"
                                                onchange="clickUploadRoleButton()">
                                        ...
                                        <div class="secondStepPolicyText">
                                            ...
                                            <div id="photoUploadTipsLink" class="headerLink tipsLink"
                                                ...
                                                <a href="{{ route('policies') }}"
                                                    target="_blank">{{ __('صفحه مقررات') }}</a>
                                                <span id="guidelinesOverlay"
                                                    class="hidden ui_overlay ui_popover arrow_top guidelinesOverlayParent ui_tooltip">
                                                    ...
                                                    <div class="body_text">
                                                        <div class="guidelinesOverlay">
                                                            ...
                                                            <div class="listFtr">Read our complete <a
                                                                    href="https://www.tripadvisorsupport.com/hc/en-us/articles/200615067-Photo-Guidelines"
                                                                    target="_blank" class="js_popFraud">photo
                                                                    submission guidelines</a>.</div>
                                                        </div>
                                                    </div>
                                                    <div class="ui_close_x"
                                                        onclick="$('#guidelinesOverlay').addClass('hidden')"></div>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="upload secondFooterVerification">
                                    <div onclick="resizeImg()" class="uploadBtn ui_button primary confirmButton"
                                        style="padding: 8px 20px;">{{ __('تایید و انتشار') }}</div>
                    ...
                    <div id="sucessUploadPicPage" class="successScreen hidden">
                        <div class="successTextBox">
                            ...
                            <div class="successTextDes">
                                {{ __('عکس شما برای ما ارسال گردید و پس از بررسی بارگذاری خواهد شد') }}</div>
                        </div>
                        <div class="uploadNextPicBtnBox">

                            <label for="uploadPhotoInputPic" style="width: 250px;">
                                <div class="uploadNextPicBtn ui_button primary confirmButton">
                                    {{ __('بارگذاری عکس بعدی') }}</div>
                            </label>
                        ...
                        <div class="footerTextBox" style="position: absolute; bottom: 0">
                            ...
                            <a href="{{ route('policies') }}" class="footerPolicyLink"
                                onclick="">{{ __('صفحه مقررات') }}</a>
                        </div>
        ...
        <div class="iconFamily iconClose closeAddPhotographer"
            onclick="$('#addPhotographerModal').addClass('hidden');"></div>
        <img alt="درنا، سامانه جامع خبری ایران" id="mainPicUploadPhotoImg" style="display: none">
    </span>
</div>
...
<script defer src="{{ URL::asset('js/component/uploadPhoto.js?v=1.1') }}"></script>
